...
import org.d3if3023.temperatureconvert.databinding.FragmentHistoryBinding
import org.d3if3023.temperatureconvert.db.ConvertionDb

class HistoryFragment : Fragment() {
    private val viewModel: HistoryViewModel by lazy {
        val data = ConvertionDb.getInstance(requireContext())
        val factory = HistoryViewModelFactory(data.dao)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.db.observe(viewLifecycleOwner) {
